...
export const DEMO_PROPERTIES: PropertyData[] = [
  ...
  // 4. LIVE PROPERTY: Nuweiba Bedouin Coast Palm Sanctuary
  {
    ...
    communityApprovalRequired: false,
    littleHutHoldsCalendar: true,
    heroImage: 'https://images.unsplash.com/photo-1571055107559-3e67626fa8be?auto=format&fit=crop&q=80&w=1600',
    galleryImages: [
      'https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&q=80&w=1200'
    ],
  ...
  // 5. SIGNED SUPPLY STAGE (Joining Little Hut): Ras El Hekma Turquoise Dune Villa
  {
    ...
    littleHutHoldsCalendar: true,
    heroImage: 'https://images.unsplash.com/photo-1505843513577-22bb7d21e455?auto=format&fit=crop&q=80&w=1600',
    galleryImages: [
      'https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=1200'
    ],
  ...
  // 8. SUBMITTED SUPPLY STAGE: Ras Sudr Kitesurf Adobe
  {
    ...
    heroImage: 'https://images.unsplash.com/photo-1510798831971-6d1eb04fd0f9?auto=format&fit=crop&q=80&w=1600',
    galleryImages: [
      'https://images.unsplash.com/photo-1571055107559-3e67626fa8be?auto=format&fit=crop&q=80&w=1200'
    ],
    isDemo: true,
...
export const DEMO_SCOUT_CANDIDATES: ScoutCandidate[] = [
  {
    ...
    candidateImage: 'https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&q=80&w=1200',
  ...
  },
  {
    ...
    status: 'under_triage',
    candidateImage: 'https://images.unsplash.com/photo-1571055107559-3e67626fa8be?auto=format&fit=crop&q=80&w=1200',
  ...
  },
  {
    ...
    candidateImage: 'https://images.unsplash.com/photo-1505843513577-22bb7d21e455?auto=format&fit=crop&q=80&w=1200',
