...
export const BRAND_IDENTITY_CARDS: BrandVisualCard[] = [
  ...
  },
  {
    id: 'card-07',
    number: '07',
    headline1: 'Coastal discovery.',
    headlineScript: 'Hidden coves.',
    headline3: 'Ocean horizons.',
    headlineAr: 'اكتشاف ساحلي..',
    headlineScriptAr: 'شواطئ مخفية..',
    headline3Ar: 'وأفق بحري مفتوح.',
    taglineEn: 'Wander where the tide meets untouched shores.',
    taglineAr: 'استكشف أسرار الساحل حيث تلتقي المياه بالشواطئ البكر.',
    cornerBoardText: 'Wander where\nthe tide meets\nuntouched shores.',
    cornerBoardTextAr: 'استكشف أسرار\nالساحل البكر.',
    sceneDescription: 'An unhurried exploration along secluded shoreline cliffs and pristine marine shallows. Salty ocean mist, private sea access, sea glass collection, and panoramic coastal lookouts without motorized watercraft noise.',
    sceneDescriptionAr: 'استكشاف متأنٍ على طول جروف الشاطئ المنعزلة ومياه البحر النقية. رذاذ البحر المالح، وصول خاص ومباشر للشاطئ، إطلالات بانورامية مفتوحة، والهدوء التام لأمواج البحر الطبيعية.',
    location: 'Ain Sokhna & Red Sea',
    locationAr: 'العين السخنة والبحر الأحمر',
    categoryEn: 'Untouched Shorelines',
    categoryAr: 'شواطئ بكر واستكشاف',
    image: '/moments/07-coastal-discovery.jpg',
    matchedMomentId: 'coastal_discovery'
  },
  {
    id: 'card-08',
    number: '08',
    headline1: 'Urban retreat.',
    headlineScript: 'Architectural quiet.',
    headline3: 'City calm.',
    headlineAr: 'ملاذ حضري..',
    headlineScriptAr: 'هدوء معماري..',
    headline3Ar: 'وسكينة في قلب المدينة.',
    taglineEn: 'A secluded sanctuary elevated above the city rhythm.',
    taglineAr: 'واحة منعزلة ومرتفعة فوق وتيرة المدينة وصخبها.',
    cornerBoardText: 'A secluded\nsanctuary above\nthe city rhythm.',
    cornerBoardTextAr: 'واحة منعزلة\nفوق صخب المدينة.',
    sceneDescription: 'An architectural oasis in the historic quarter. Soaring ceilings, private courtyard gardens with living greenery, curated library sanctuaries, and double-glazed acoustic tranquility while the city hums beyond thick stone walls.',
    sceneDescriptionAr: 'واحة معمارية داخل الأحياء التاريخية الراقية. أسقف عالية، فناء داخلي خاص بأشجار مورقة، مكتبات منتقاة بعناية، وعزل صوتي فائق وسكينة تامة خلف جدران حجرية سميكة.',
    location: 'Alexandria & Cairo',
    locationAr: 'الإسكندرية والقاهرة',
    categoryEn: 'Courtyard Sanctuaries',
    categoryAr: 'ملاذات وأفنية هادئة',
    image: '/moments/08-urban-retreat.jpg',
    matchedMomentId: 'urban_retreat'
  }
];
